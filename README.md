...
│   │   ├── services/               # Backend business logic and processing
...
├── Simulation/
│   └── frontend/
│       ├── src/                    # Simulation UI source
│       ├── public/                 # Static simulation assets
│       └── package.json            # Simulation frontend dependencies
│
├── Ml/
